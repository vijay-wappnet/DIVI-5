...
<head>
	...
	<meta name="google-site-verification" content="54w8qtbFm2pT7_SIOv3eYLcVzwyl2F2HbE8q10EfWLA" />
...
?>
	...
	<!-- Google tag (gtag.js) -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-NBVHHE9QDP"></script>
		<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'G-NBVHHE9QDP');
		</script>
